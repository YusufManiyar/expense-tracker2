...
if(localStorage.getItem('token') !== null){
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        purchase.addEventListener('click', async function(event) {
            ...
            const response = await fetch(`${config.BACKEND_URL}/purchase/premiummembership`, {headers: {
            ...
            var options = {
                ...
                handler: async function(response) {
                    const resp = await fetch(`${config.BACKEND_URL}/purchase/updatetransationstatus`, {method:'POST', headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
                      },
                      body: JSON.stringify(
        ...
        async function saveExpense(description, category, amount) {
            ...
            let data
            if(mode == 'add') {
                const response = await fetch(`${config.BACKEND_URL}/expense`, {method: 'POST', headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
                  },
                ...
                const response = await fetch(`${config.BACKEND_URL}/expense`, {method: 'PUT', headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
                  },
                  body: JSON.stringify(transaction),
